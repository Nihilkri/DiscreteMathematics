...
if __name__ == "__main__":
  ...
  #cm = "10 32 14 9 9 32 24 1 5 32 1 32 4 16 14 17 9 5 32 28 27 24 3 4 14"
  cm = "3, 32, 14, 24, 3, 26, 31, 32, 14, 9, 32, 31, 9, 32, 3, 14, 32, 23, 3, 14, 17, 9, 21, 14, 32, 9, 5, 26, 32, 9, 5, 32, 26, 30, 27, 26, 12, 32, 1, 5, 31, 32, 13, 1, 22, 26, 32, 21, 4"
  txt2 = decodeMessage(cm, p, q, e, dbug)
  print(txt2)

  # cm = "14 26 01 23 05 32 31 15 30"
  # for e in range(2, 34):
  #   txt2 = decodeMessage(cm, p, q, e, dbug)
  #   if(txt2 == "GREAT JOB"):
  #     print(e)
